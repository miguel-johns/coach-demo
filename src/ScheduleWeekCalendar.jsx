...
export default function ScheduleWeekCalendar({ isMobile }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: 720, maxHeight: "80vh", background: PAGE_BG, position: "relative", overflow: "hidden", border: `1px solid ${B_SOFT}`, borderRadius: 16, boxShadow: SHADOW_CARD }}>
      {/* header */}
