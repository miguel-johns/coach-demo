...
import StoriesCanvas from "./dashboards/StoriesCanvas";
    ...
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", borderBottom: `1px solid ${BORDER}` }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button onClick={onClose} title="Close" style={{ background: "none", border: "none", cursor: "pointer", padding: 4, color: TEXT_SEC }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
          </button>
        </div>
      </div>
...
function AIDashboardsCanvas({ onClose, onHome, isMobile, pendingEdit, onEditProcessed }) {
  return (
    <div style={{
      display: "flex", flexDirection: "column", height: "100%",
      position: "relative", background: "#f5f7f6", fontFamily: "'DM Sans', sans-serif"
    }}>
      ...
      <iframe
        title="Brief Builder"
        srcDoc={briefBuilderHtml}
        style={{ flex: 1, width: "100%", border: "none", background: "#f5f7f6" }}
      />
    </div>
  );
}
          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: homeCompact ? "repeat(2, 1fr)" : "repeat(3, 1fr)", gap: homeCompact ? 10 : 14, alignItems: "start" }}>
              ...
              {[
                ...
                { icon: "send", label: "Progress Stories", desc: "Shareable client wins", color: "#2B7A78", badge: 2, badgeLabel: "ready", badgeColor: "#2B7A78", onClick: () => { setCanvasType("stories"); setCanvasData({}); setCanvasMode(true); } },
