    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", position: "relative", background: "#fafcfb" }}>
      ...
      {isMobile ? (
        <div style={{ 
          ...
          {/* Top row: Close, Title, Save & Client */}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: TEXT }}>Workout Calendar</div>
            </div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 18, fontWeight: 700, color: TEXT }}>{formatMobileDate(mobileCurrentDay)}</div>
              <div style={{ fontSize: 12, color: TEXT_SEC }}>
